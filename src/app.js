...
const render = () => {
  ...
  statusElement.textContent = `${result.shapeCount} Kontur(en) mit ${result.pointCount} Punkten erkannt. SVG-Größe: ${Math.round(result.width)} × ${Math.round(result.height)}px.`;
